...
Possiamo notare dai log mostrati nella \cref{fig:gradient-nodes} che i nodi sono riusciti a
scovarsi l'un l'altro nella rete autonomamente senza connesioni dirette, per poi
correttamente condividere i risultati del gradiente ad ogni iterazione, ottenendo
i valori finali previsti di 0 per il nodo 1 sorgente, 1 per il nodo 2 e 2.5
(dato dalla somma di 1 + 1.5) per il nodo 3.
...
In particolare, nella \cref{fig:gradient-node3} si può notare come dopo aver interrotto il nodo 2
manualmente i suoi risultati sono diventati obsoleti e di conseguenza eliminati
dalla rete.
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/gradient-node1}
        \caption{Nodo 1.}
        \label{fig:gradient-node1}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/gradient-node2}
        \caption{Nodo 2.}
        \label{fig:gradient-node2}
    \end{subfigure}
    \vfill
    \begin{subfigure}{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/gradient-node3}
        \caption{Nodo 3.}
        \label{fig:gradient-node3}
    \end{subfigure}
    \caption{Log di esecuzione del test del gradiente per la rete Zenoh.}
    \label{fig:gradient-nodes}
\end{figure}
