...
tra i nodi sono basate sul concetto di vicinato definito distanza cartesiana tra loro
\cite[12.2.2]{10.1007/978-3-031-95589-1_12} (\Cref{fig:gradient_ac}).

\begin{figure}[htpb]
    \centering
    \input{figures/ac-gradient.tex}
