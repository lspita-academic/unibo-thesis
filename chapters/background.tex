...
con un supporto nativo del compilatore per la compilazione per diverse architetture,
per l'accesso alla libreria standard completamente opzionale per i dispositivi che non
...
l'interazione con le periferiche hardware disponibili sul microcontrollore tramite
un'unica \ac{API} compatibile con tutti i dispositivi da loro prodotti, sfruttando
la natura \emph{memory-safe} e le funzionalità di gestione degli errori del
linguaggio per garantire un accesso facile e sicuro a funzionalità come Wi-Fi e
comunicazione seriale, spesso utilizzate nel campo dello \ac{IoT}.
