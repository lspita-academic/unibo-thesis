...
In apertura si delineano i principi dello \ac{AC} \sidenote{Con le parole inglesi
non bisogna usare l'apostrofo vero?}, con particolare
...
Zenoh \footnote{\url{https://zenoh.io/}} e l'ecosistema di Rust per la programmazione
embedded.
...
coordinamento di sistemi altamente distribuiti, dove gli approcci di programmazione
tradizionali faticano a gestire la complessità derivante dalla necessità di far
cooperare centinaia o migliaia di dispositivi in modo trasparente e
resiliente~\cite[12.1]{10.1007/978-3-031-95589-1_12}.
