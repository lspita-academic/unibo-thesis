...
\subsection{Integrazione con YAAIR}
...
operazioni, così da poter adeguare l'implementazione di conseguenza.
...
\begin{itemize}
    ...
    di \ac{YAAIR}, lo \texttt{InboundMessage}, che associa ogni nodo raggiungibile
...
\subsection{La ZenohNetwork}
\label{ssec:the-zenoh-network}
